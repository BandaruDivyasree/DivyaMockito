...
@Test
@DisplayName("showMobiles")
void testShowMobiles() throws MobileNotFoundExceptions {
...
@Test
@DisplayName("checkMobileInvalid")
void testshowMobilesInvalid() throws MobileNotFoundExceptions {
Mockito.when(mobileService.getByBrand("vivo")).thenThrow(MobileNotFoundExceptions.class);
assertThrows(MobileNotFoundExceptions.class, () -> orderDetails.showMobiles("vivo"));
}

@Test
@DisplayName(" check Mobile null")
void testShowMobilesNull() throws MobileNotFoundExceptions {
String brand = "Samsung";
...
@Test
@DisplayName("check mobile empty")
void testShowMobilesEmpty() throws MobileNotFoundExceptions {
String brand = "Moto";
...
@Test
@DisplayName("check sort by brand")
void testShowMobilesSortByBrand() throws MobileNotFoundExceptions {
String brand = "Samsung";
List<Mobile> expectedMobiles = Arrays.asList(mobile1, mobile6);
...
@Test
@DisplayName("check test order")
void testOrderMobile() throws MobileNotFoundExceptions {
int id = 1;
...
@Test
@DisplayName("check order invalid")
void testOrderInvalid() throws MobileNotFoundExceptions {
...
void testOrderException() throws MobileNotFoundExceptions {

String expected="mobile not ordered";
Mockito.when(mobileService.getById(15)).thenThrow(MobileNotFoundExceptions.class);
String actual=orderDetails.orderMobile(15);
assertEquals(expected, actual, "Mobile not same");
}
@Test
@DisplayName("check with empty object")
void testOrderEmpty() throws  MobileNotFoundExceptions{
 String expected="mobile not ordered";
 Mockito.when(mobileService.getById(15)).thenReturn(new Mobile()); String
actual=orderDetails.orderMobile(15); System.out.println(actual);
